...
var schema = {
    elements: {
        ...
        End: schemaElement(
        /*attributes*/["Type", "Role", "EntitySet", "Multiplicity"],
        /*elements*/null
        ),
        Eq: schemaElement(
        /*attributes*/null,
        ...
        /*elements*/["EntitySet*", "Singleton*", "ActionImport*", "FunctionImport*", "AssociationSet*", "Annotation*"]
        ),
        ...
        /*attributes*/["Name", "Type", "Nullable", "Partner", "ContainsTarget", "Relationship", "ToRole", "FromRole"],
        ...
        /*attributes*/["Name", "Type", "Nullable", "MaxLength", "Precision", "Scale", "Unicode", "SRID", "DefaultValue", "StoreGeneratedPattern"],
        /*elements*/["Annotation*"]
        ),
        ...
        /*elements*/["Action*", "Annotations*", "Association*", "Annotation*", "ComplexType*", "EntityContainer", "EntityType*", "EnumType*", "Function*", "Term*", "TypeDefinition*", "Annotation*"]
        ),
        ...
        /*attributes*/["MaxDataServiceVersion", "DataServiceVersion"],
        /*elements*/["Schema*"],
        /*text*/false,
        /*ns*/edmxNs
        ),
...
function parseConceptualModelElement(element) {
    ...
    xmlAttributes(element, function (attribute) {
        ...
        if (contains(attributes, localName)) {
